...
public class PlayerMover : MonoBehaviour
{
	...
	[HideInInspector] public BaseControls controls;
	...
	private void Start()
	{
		controls = GetComponent<KeyboardControls>();
	...
	private void Update()
	{
		...
		if (controls.GetJump() && _isGrounded)
		{
			Jump();
		}
	}
	...
	private void Move()
	{
		_direction = controls.GetHorizontalInput();
